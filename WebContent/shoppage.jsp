     ...
     <div class="main">
      <div class="shop_top">
		<div class="container">
			<div class="row shop_box-top">
				...
				<div class="col-md-3 shop_box"><a href="single.html">
					...
					<div class="shop_desc">
						...
						<a href="ProductEditServlet?id=${p.id }">修改</a>
						<a style="float: right;" href="ProductDelServlet?id=${p.id }">删除</a>
						<ul class="buttons">
							<li class="cart"><a href="CartServlet?id=${p.id }">加入购物车</a></li>
			...
			<a href="ProductPageServlet">首页</a>&nbsp;
			<a href="ProductPageServlet?pageNum=${page.prePageNum }">上一页</a>&nbsp;
			<span>${page.pageNum }</span>&nbsp;
			<a href="ProductPageServlet?pageNum=${page.nextPageNum }">下一页</a>&nbsp;
			<a href="ProductPageServlet?pageNum=${page.totalPageNum }">尾页</a>&nbsp;
		 </div>
	   </div>
	  </div>
	  <div class="footer">
